...
#ifndef ROBOTIS_MAX_ONLINE_WALKING_MODULE_WHOLEBODY_CONTROL_
#define ROBOTIS_MAX_ONLINE_WALKING_MODULE_WHOLEBODY_CONTROL_
...
#endif /* ROBOTIS_MAX_ONLINE_WALKING_MODULE_WHOLEBODY_CONTROL_ */
