...
#ifndef ROBOTIS_MAX_ONLINE_WALKING_MODULE_ONLINE_WALKING_MODULE_H_
#define ROBOTIS_MAX_ONLINE_WALKING_MODULE_ONLINE_WALKING_MODULE_H_
...
#include "robotis_max_balance_control/robotis_max_balance_control.h"

#include "robotis_max_online_walking_module_msgs/JointPose.h"
#include "robotis_max_online_walking_module_msgs/KinematicsPose.h"
#include "robotis_max_online_walking_module_msgs/FootStepCommand.h"
#include "robotis_max_online_walking_module_msgs/PreviewRequest.h"
#include "robotis_max_online_walking_module_msgs/PreviewResponse.h"
#include "robotis_max_online_walking_module_msgs/WalkingParam.h"

#include "robotis_max_online_walking_module_msgs/GetJointPose.h"
#include "robotis_max_online_walking_module_msgs/GetKinematicsPose.h"
#include "robotis_max_online_walking_module_msgs/GetPreviewMatrix.h"

#include "robotis_max_online_walking_module_msgs/Step2D.h"
...
public:
  ...
  void goalJointPoseCallback(const robotis_max_online_walking_module_msgs::JointPose &msg);
  void goalKinematicsPoseCallback(const robotis_max_online_walking_module_msgs::KinematicsPose& msg);
  void footStepCommandCallback(const robotis_max_online_walking_module_msgs::FootStepCommand& msg);
  void walkingParamCallback(const robotis_max_online_walking_module_msgs::WalkingParam& msg);

  void footStep2DCallback(const robotis_max_online_walking_module_msgs::Step2DArray& msg);
  ...
  bool getJointPoseCallback(robotis_max_online_walking_module_msgs::GetJointPose::Request &req,
                            robotis_max_online_walking_module_msgs::GetJointPose::Response &res);
  bool getKinematicsPoseCallback(robotis_max_online_walking_module_msgs::GetKinematicsPose::Request &req,
                                 robotis_max_online_walking_module_msgs::GetKinematicsPose::Response &res);
  bool getPreviewMatrix(robotis_max_online_walking_module_msgs::PreviewRequest msg);
...
//  ros::ServiceClient get_preview_matrix_client_;
  ...
  robotis_max_online_walking_module_msgs::FootStepCommand foot_step_command_;
  robotis_max_online_walking_module_msgs::PreviewRequest preview_request_;
  robotis_max_online_walking_module_msgs::PreviewResponse preview_response_;
  robotis_max_online_walking_module_msgs::WalkingParam walking_param_;

  robotis_max_online_walking_module_msgs::Step2DArray foot_step_2d_;
...
#endif /* ROBOTIS_MAX_ONLINE_WALKING_MODULE_ONLINE_WALKING_MODULE_H_ */
