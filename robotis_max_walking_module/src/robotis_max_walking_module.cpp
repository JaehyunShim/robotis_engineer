...
void WalkingModule::initialize(const int control_cycle_msec, robotis_framework::Robot *robot)
{
  ...
  std::string default_param_path = ros::package::getPath("max_walking_module") + "/config/param.yaml";
...
void WalkingModule::walkingParameterCallback(const robotis_max_walking_module_msgs::WalkingParam::ConstPtr &msg)
{
  walking_param_ = *msg;
}

bool WalkingModule::getWalkigParameterCallback(robotis_max_walking_module_msgs::GetWalkingParam::Request &req,
