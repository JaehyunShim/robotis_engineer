...
#ifndef ROBOTIS_MAX_WALKING_MODULE_H_
#define ROBOTIS_MAX_WALKING_MODULE_H_

#include "robotis_max_walking_parameter.h"
...
class WalkingModule : public robotis_framework::MotionModule, public robotis_framework::Singleton<WalkingModule>
{
 ...
 private:
  ...
  void walkingParameterCallback(const robotis_max_walking_module_msgs::WalkingParam::ConstPtr &msg);
  bool getWalkigParameterCallback(robotis_max_walking_module_msgs::GetWalkingParam::Request &req,
                                  robotis_max_walking_module_msgs::GetWalkingParam::Response &res);
  ...
  Eigen::MatrixXd target_position_;   // for what? target and goal.?
...
#endif /* ROBOTIS_MAX_WALKING_MODULE_H_ */
