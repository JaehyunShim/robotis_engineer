...
#ifndef ROBOTIS_ENGINEER_WALKING_MODULE_H_
#define ROBOTIS_ENGINEER_WALKING_MODULE_H_

#include "robotis_engineer_walking_parameter.h"
...
class WalkingModule : public robotis_framework::MotionModule, public robotis_framework::Singleton<WalkingModule>
{
 ...
 private:
  ...
  void walkingParameterCallback(const robotis_engineer_walking_module_msgs::WalkingParam::ConstPtr &msg);
  bool getWalkigParameterCallback(robotis_engineer_walking_module_msgs::GetWalkingParam::Request &req,
  ...
  EngineerKinematicsDynamics* robotis_engineer_kd_;
...
#endif /* ROBOTIS_ENGINEER_WALKING_MODULE_H_ */
