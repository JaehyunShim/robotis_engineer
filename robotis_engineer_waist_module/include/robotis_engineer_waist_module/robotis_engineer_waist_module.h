...
#ifndef ROBOTIS_ENGINEER_WAIST_MODULE_H_
#define ROBOTIS_ENGINEER_WAIST_MODULE_H_
...
class WaistControlModule : public robotis_framework::MotionModule, public robotis_framework::Singleton<WaistControlModule>
{
 public:
  WaistControlModule();
  virtual ~WaistControlModule();
 ...
 private:
  ...
  void setWaistJointCallback(const sensor_msgs::JointState::ConstPtr &msg);
  void setWaistJointOffsetCallback(const sensor_msgs::JointState::ConstPtr &msg);
  void setWaistScanCallback(const std_msgs::String::ConstPtr &msg);

  void queueThread();
  void jointTraGeneThread();
  void setWaistJoint(const sensor_msgs::JointState::ConstPtr &msg, bool is_offset);
  bool checkAngleLimit(const int joint_index, double &goal_position);
  void generateScanTra(const int waist_direction);
...
#endif /* ROBOTIS_ENGINEER_WAIST_MODULE_H_ */
