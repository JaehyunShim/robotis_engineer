...
#ifndef ROBOTIS_MAX_ACTION_MOTION_MODULE_H_
#define ROBOTIS_MAX_ACTION_MOTION_MODULE_H_
...
#include "robotis_max_action_module_msgs/IsRunning.h"
#include "robotis_max_action_module_msgs/StartAction.h"
...
private:
  ...
  bool isRunningServiceCallback(robotis_max_action_module_msgs::IsRunning::Request  &req,
                                robotis_max_action_module_msgs::IsRunning::Response &res);

  void pageNumberCallback(const std_msgs::Int32::ConstPtr& msg);
  void startActionCallback(const robotis_max_action_module_msgs::StartAction::ConstPtr& msg);
...
#endif /* ROBOTIS_MAX_ACTION_MOTION_MODULE_H_ */
