...
#include "../include/robotis_engineer_control_gui/preview_walking_form.h"
...
{
  robotis_engineer_online_walking_module_msgs::WalkingParam msg;
...
{
  robotis_engineer_online_walking_module_msgs::FootStepCommand msg;
