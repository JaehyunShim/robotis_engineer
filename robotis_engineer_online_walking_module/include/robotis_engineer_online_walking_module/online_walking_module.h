...
#ifndef ROBOTIS_ENGINEER_ONLINE_WALKING_MODULE_ONLINE_WALKING_MODULE_H_
#define ROBOTIS_ENGINEER_ONLINE_WALKING_MODULE_ONLINE_WALKING_MODULE_H_
...
#include "robotis_engineer_kdl.h"
...
#include "robotis_engineer_balance_control/robotis_engineer_balance_control.h"

#include "robotis_engineer_online_walking_module_msgs/JointPose.h"
#include "robotis_engineer_online_walking_module_msgs/KinematicsPose.h"
#include "robotis_engineer_online_walking_module_msgs/FootStepCommand.h"
#include "robotis_engineer_online_walking_module_msgs/PreviewRequest.h"
#include "robotis_engineer_online_walking_module_msgs/PreviewResponse.h"
#include "robotis_engineer_online_walking_module_msgs/WalkingParam.h"

#include "robotis_engineer_online_walking_module_msgs/GetJointPose.h"
#include "robotis_engineer_online_walking_module_msgs/GetKinematicsPose.h"
#include "robotis_engineer_online_walking_module_msgs/GetPreviewMatrix.h"

#include "robotis_engineer_online_walking_module_msgs/Step2D.h"
...
public:
  ...
  void goalJointPoseCallback(const robotis_engineer_online_walking_module_msgs::JointPose &msg);
  void goalKinematicsPoseCallback(const robotis_engineer_online_walking_module_msgs::KinematicsPose& msg);
  void footStepCommandCallback(const robotis_engineer_online_walking_module_msgs::FootStepCommand& msg);
  void walkingParamCallback(const robotis_engineer_online_walking_module_msgs::WalkingParam& msg);

  void footStep2DCallback(const robotis_engineer_online_walking_module_msgs::Step2DArray& msg);
  ...
  bool getJointPoseCallback(robotis_engineer_online_walking_module_msgs::GetJointPose::Request &req,
                            robotis_engineer_online_walking_module_msgs::GetJointPose::Response &res);
  bool getKinematicsPoseCallback(robotis_engineer_online_walking_module_msgs::GetKinematicsPose::Request &req,
                                 robotis_engineer_online_walking_module_msgs::GetKinematicsPose::Response &res);
  bool getPreviewMatrix(robotis_engineer_online_walking_module_msgs::PreviewRequest msg);
  ...
  EngineerKinematics *robotis_engineer_kdl_;
...
//  ros::ServiceClient get_preview_matrix_client_;
  ...
  robotis_engineer_online_walking_module_msgs::FootStepCommand foot_step_command_;
  robotis_engineer_online_walking_module_msgs::PreviewRequest preview_request_;
  robotis_engineer_online_walking_module_msgs::PreviewResponse preview_response_;
  robotis_engineer_online_walking_module_msgs::WalkingParam walking_param_;

  robotis_engineer_online_walking_module_msgs::Step2DArray foot_step_2d_;
...
#endif /* ROBOTIS_ENGINEER_ONLINE_WALKING_MODULE_ONLINE_WALKING_MODULE_H_ */
