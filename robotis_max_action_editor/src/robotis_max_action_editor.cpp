...
#include "robotis_max_action_editor/robotis_max_action_editor.h"
                                          ...
                                          std::string offset_file_path)
{
  ...
  default_editor_script_path_ = ros::package::getPath("action_editor") + "/config/editor_script.yaml";
  mirror_joint_file_path_ = ros::package::getPath("action_editor") + "/config/config_mirror_joint.yaml";
