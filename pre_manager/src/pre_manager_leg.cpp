...
#include "pre_arm_module/pre_arm_module.h"
#include "pre_head_module/pre_head_module.h"
#include "pre_waist_module/pre_waist_module.h"
#include "pre_action_module/pre_action_module.h"
#include "pre_walking_module/pre_walking_module.h"
...
const std::string SUB_CONTROLLER_DEVICE = "/dev/ttyACM0"; // Device Name
const int POWER_CTRL_TABLE = 24;                          // 
const int RGB_LED_CTRL_TABLE = 26;												//
const int TORQUE_ON_CTRL_TABLE = 64;											// Torque Enable
