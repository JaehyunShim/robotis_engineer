    ...
    DEBUG(false)
{
  ...
  max_angle_[using_joint_name_["head_pan"]] = 45 * DEGREE2RADIAN;
  min_angle_[using_joint_name_["head_pan"]] = -45 * DEGREE2RADIAN;
  max_angle_[using_joint_name_["head_tilt"]] = 90 * DEGREE2RADIAN;
  min_angle_[using_joint_name_["head_tilt"]] = -5 * DEGREE2RADIAN;
