...
#ifndef ROBOTIS_ENGINEER_ACTION_MOTION_MODULE_H_
#define ROBOTIS_ENGINEER_ACTION_MOTION_MODULE_H_
...
#include "robotis_engineer_action_module_msgs/IsRunning.h"
#include "robotis_engineer_action_module_msgs/StartAction.h"
...
private:
  ...
  bool isRunningServiceCallback(robotis_engineer_action_module_msgs::IsRunning::Request  &req,
                                robotis_engineer_action_module_msgs::IsRunning::Response &res);

  void pageNumberCallback(const std_msgs::Int32::ConstPtr& msg);
  void startActionCallback(const robotis_engineer_action_module_msgs::StartAction::ConstPtr& msg);
...
#endif /* ROBOTIS_ENGINEER_ACTION_MOTION_MODULE_H_ */
