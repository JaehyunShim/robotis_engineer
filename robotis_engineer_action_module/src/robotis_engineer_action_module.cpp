...
bool ActionModule::isRunningServiceCallback(robotis_engineer_action_module_msgs::IsRunning::Request &req,
...
void ActionModule::startActionCallback(const robotis_engineer_action_module_msgs::StartAction::ConstPtr& msg)
{
  if (enable_ == false)
  {
    std::string status_msg = "Action Module is not enabled";
