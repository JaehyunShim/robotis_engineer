...
bool ActionModule::isRunningServiceCallback(max_action_module_msgs::IsRunning::Request &req,
...
void ActionModule::startActionCallback(const max_action_module_msgs::StartAction::ConstPtr& msg)
{
  if (enable_ == false)
  {
    std::string status_msg = "Action Module is not enabled";
