...
#ifndef MAX_ACTION_MOTION_MODULE_H_
#define MAX_ACTION_MOTION_MODULE_H_
...
#include "max_action_module_msgs/IsRunning.h"
#include "max_action_module_msgs/StartAction.h"
...
private:
  ...
  bool isRunningServiceCallback(max_action_module_msgs::IsRunning::Request  &req,
                                max_action_module_msgs::IsRunning::Response &res);

  void pageNumberCallback(const std_msgs::Int32::ConstPtr& msg);
  void startActionCallback(const max_action_module_msgs::StartAction::ConstPtr& msg);
...
#endif /* MAX_ACTION_MOTION_MODULE_H_ */
