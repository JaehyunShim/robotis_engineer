...
void OnlineWalkingModule::initialize(const int control_cycle_msec, robotis_framework::Robot *robot)
{
  ...
  // Service
//  get_preview_matrix_client_ = ros_node.serviceClient<max_online_walking_module_msgs::GetPreviewMatrix>("/robotis/online_walking/get_preview_matrix", 0);
}
...
void OnlineWalkingModule::walkingParamCallback(const max_online_walking_module_msgs::WalkingParam& msg)
{
  walking_param_ = msg;
}

void OnlineWalkingModule::goalJointPoseCallback(const max_online_walking_module_msgs::JointPose& msg)
{
  if (enable_ == false)
    return;
...
void OnlineWalkingModule::goalKinematicsPoseCallback(const max_online_walking_module_msgs::KinematicsPose& msg)
{
  if (enable_ == false)
    return;
...
void OnlineWalkingModule::footStep2DCallback(const max_online_walking_module_msgs::Step2DArray& msg)
{
  if (enable_ == false)
    return;
  ...
  max_online_walking_module_msgs::Step2DArray foot_step_msg;

  int old_size = msg.footsteps_2d.size();
  int new_size = old_size + 3;

  max_online_walking_module_msgs::Step2D first_msg;
  max_online_walking_module_msgs::Step2D second_msg;
  ...
  if (control_type_ == NONE || control_type_ == WALKING_CONTROL)
  {
    ...
    {
      max_online_walking_module_msgs::Step2D step_msg = msg.footsteps_2d[i];
    ...
    max_online_walking_module_msgs::Step2D step_msg = msg.footsteps_2d[old_size-1];
...
void OnlineWalkingModule::footStepCommandCallback(const max_online_walking_module_msgs::FootStepCommand& msg)
{
  if (enable_ == false)
    return;
...
bool OnlineWalkingModule::getJointPoseCallback(max_online_walking_module_msgs::GetJointPose::Request &req,
                                           max_online_walking_module_msgs::GetJointPose::Response &res)
{
  for (int i=0; i<number_of_joints_; i++)
  {
...
bool OnlineWalkingModule::getKinematicsPoseCallback(max_online_walking_module_msgs::GetKinematicsPose::Request &req,
                                                max_online_walking_module_msgs::GetKinematicsPose::Response &res)
{
