...
#ifndef MAX_ONLINE_WALKING_MODULE_WALKING_CONTROL_
#define MAX_ONLINE_WALKING_MODULE_WALKING_CONTROL_
...
#include "max_online_walking_module_msgs/FootStepArray.h"
...
public:
  ...
  void initialize(max_online_walking_module_msgs::FootStepCommand foot_step_command,
  ...
  void initialize(max_online_walking_module_msgs::Step2DArray foot_step_2d,
                  std::vector<double_t> init_body_pos, std::vector<double_t> init_body_Q,
                  std::vector<double_t> init_r_foot_pos, std::vector<double_t> init_r_foot_Q,
                  std::vector<double_t> init_l_foot_pos, std::vector<double_t> init_l_foot_Q);
  void next();
...
//  thormang3::KinematicsDynamics *robot_;
  ...
  max_online_walking_module_msgs::FootStepArray foot_step_param_;
...
#endif /* MAX_ONLINE_WALKING_MODULE_WALKING_CONTROL_ */
