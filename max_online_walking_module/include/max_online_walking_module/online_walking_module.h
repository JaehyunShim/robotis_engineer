...
#ifndef MAX_ONLINE_WALKING_MODULE_ONLINE_WALKING_MODULE_H_
#define MAX_ONLINE_WALKING_MODULE_ONLINE_WALKING_MODULE_H_
...
#include "max_balance_control/max_balance_control.h"

#include "max_online_walking_module_msgs/JointPose.h"
#include "max_online_walking_module_msgs/KinematicsPose.h"
#include "max_online_walking_module_msgs/FootStepCommand.h"
#include "max_online_walking_module_msgs/PreviewRequest.h"
#include "max_online_walking_module_msgs/PreviewResponse.h"
#include "max_online_walking_module_msgs/WalkingParam.h"

#include "max_online_walking_module_msgs/GetJointPose.h"
#include "max_online_walking_module_msgs/GetKinematicsPose.h"
#include "max_online_walking_module_msgs/GetPreviewMatrix.h"
...
public:
  ...
  void goalJointPoseCallback(const max_online_walking_module_msgs::JointPose &msg);
  void goalKinematicsPoseCallback(const max_online_walking_module_msgs::KinematicsPose& msg);
  void footStepCommandCallback(const max_online_walking_module_msgs::FootStepCommand& msg);
  void walkingParamCallback(const max_online_walking_module_msgs::WalkingParam& msg);

  void footStep2DCallback(const max_online_walking_module_msgs::Step2DArray& msg);
  ...
  bool getJointPoseCallback(max_online_walking_module_msgs::GetJointPose::Request &req,
                            max_online_walking_module_msgs::GetJointPose::Response &res);
  bool getKinematicsPoseCallback(max_online_walking_module_msgs::GetKinematicsPose::Request &req,
                                 max_online_walking_module_msgs::GetKinematicsPose::Response &res);
  bool getPreviewMatrix(max_online_walking_module_msgs::PreviewRequest msg);
...
//  ros::ServiceClient get_preview_matrix_client_;
  ...
  max_online_walking_module_msgs::FootStepCommand foot_step_command_;
  max_online_walking_module_msgs::PreviewRequest preview_request_;
  max_online_walking_module_msgs::PreviewResponse preview_response_;
  max_online_walking_module_msgs::WalkingParam walking_param_;

  max_online_walking_module_msgs::Step2DArray foot_step_2d_;
...
#endif /* MAX_ONLINE_WALKING_MODULE_ONLINE_WALKING_MODULE_H_ */
