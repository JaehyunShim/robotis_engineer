...
#ifndef MAX_ONLINE_WALKING_MODULE_WHOLEBODY_CONTROL_
#define MAX_ONLINE_WALKING_MODULE_WHOLEBODY_CONTROL_
...
#endif /* MAX_ONLINE_WALKING_MODULE_WHOLEBODY_CONTROL_ */
