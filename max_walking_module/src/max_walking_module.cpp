...
void WalkingModule::walkingParameterCallback(const max_walking_module_msgs::WalkingParam::ConstPtr &msg)
{
  walking_param_ = *msg;
}

bool WalkingModule::getWalkigParameterCallback(max_walking_module_msgs::GetWalkingParam::Request &req,
