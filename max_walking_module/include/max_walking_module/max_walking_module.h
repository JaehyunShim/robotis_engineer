...
#ifndef MAX_WALKING_MODULE_H_
#define MAX_WALKING_MODULE_H_

#include "max_walking_parameter.h"
...
class WalkingModule : public robotis_framework::MotionModule, public robotis_framework::Singleton<WalkingModule>
{
 ...
 private:
  ...
  void walkingParameterCallback(const max_walking_module_msgs::WalkingParam::ConstPtr &msg);
  bool getWalkigParameterCallback(max_walking_module_msgs::GetWalkingParam::Request &req,
                                  max_walking_module_msgs::GetWalkingParam::Response &res);
